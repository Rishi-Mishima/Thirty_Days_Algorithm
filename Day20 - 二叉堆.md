...
> 为啥叫优先级「队列」？
>
> > 主要是因为这个数据结构的 API 和我们之前讲的 [标准队列 API](https://labuladong.online/zh/algo/data-structure-basic/queue-stack-basic/) 很像，标准队列是先进先出的顺序，而二叉堆可以理解为一种会自动排序的队列，所以叫做优先级队列感觉也挺贴切的。
> >
